...
function useProduct(args = {}) {
  ...
  const onPublishProduct = useCallback(async ({ productId: productIdLocal = product._id }) => {
    try {
      ...
      enqueueSnackbar(t("admin.catalogProductPublishSuccess"), { variant: "success" });
    } catch (error) {
  ...
  const onArchiveProduct = useCallback(async (productLocal, redirectUrl) => {
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.archiveProductsSuccess"), { variant: "success" });
      history.push(redirectUrl);
    } catch (error) {
      enqueueSnackbar(t("productDetailEdit.archiveProductsFail"), { variant: "success" });
    }
  }, [
    enqueueSnackbar,
    history,
  ...
  const onCloneProduct = useCallback(async (productLocal) => {
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.cloneProductSuccess"), { variant: "success" });
    } catch (error) {
  ...
  const onCreateVariant = useCallback(async ({
    ...
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.addVariant"), { variant: "success" });
    } catch (error) {
  ...
  const onToggleProductVisibility = useCallback(async () => {
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.updateProductFieldSuccess"), { variant: "success" });
    } catch (error) {
  ...
  const handleDeleteProductTag = useCallback(async ({
    ...
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.removeProductTagSuccess"), { variant: "success" });
    } catch (error) {
      enqueueSnackbar(t("productDetailEdit.removeProductTagFail"), { variant: "error" });
    }
  }, [
    enqueueSnackbar,
    product,
  ...
  const onUpdateProductVariant = useCallback(async ({
    ...
    try {
      ...
      enqueueSnackbar(t("productVariant.updateVariantSuccess"), { variant: "success" });
    } catch (error) {
  ...
  const onUpdateProductVariantPrices = useCallback(async ({
    ...
    try {
      ...
      enqueueSnackbar(t("productVariant.updateVariantPricesSuccess"), { variant: "success" });
    } catch (error) {
  ...
  const onArchiveProductVariants = useCallback(async ({
    ...
    try {
      ...
      enqueueSnackbar(t("productDetailEdit.archiveProductVariantsSuccess"), { variant: "success" });
    } catch (error) {
