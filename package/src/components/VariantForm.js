  ...
  renderInventoryPolicyField() {
    ...
    return (
      <div className="col-sm-12">
        ...
        {hasChildVariants &&
          <FormHelperText>
            {t("admin.helpText.variantBackorderToggle")}
          </FormHelperText>
        }
      </div>
    );
    ...
    return (
      <div>
        <Card className={classes.card}>
          <CardHeader title={t("productDetailEdit.variantDetails")} />
          <CardContent>
            <Components.TextField
        ...
        <Card className={classes.card}>
          <CardHeader title={t("productVariant.taxable")} />
          <CardContent>
            <FormControlLabel
              control={
                <Switch
        ...
        <Card className={classes.card}>
          <CardHeader title={t("productVariant.inventoryManagement")} />
